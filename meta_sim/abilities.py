...
ABILITY_PRIORITY = [
    ...
    'SERENE_GRACE', 'SHIELD_DUST', 'SKILL_LINK', 'ROCK_HEAD', 'HYPER_CUTTER',
    'EFFECT_SPORE', 'POISON_TOUCH', 'TANGLING_HAIR', 'AFTERMATH', 'LIQUID_OOZE',
    # status / utility
    'POISON_HEAL', 'MAGIC_GUARD', 'NATURAL_CURE', 'SHED_SKIN', 'ICE_BODY', 'RAIN_DISH',
    'GUTS', 'QUICK_FEET', 'MARVEL_SCALE', 'SPEED_BOOST', 'PRANKSTER',
    'GALE_WINGS', 'TRIAGE', 'SCRAPPY', 'MINDS_EYE',
    'CLEAR_BODY', 'WHITE_SMOKE', 'SYNCHRONIZE', 'OWN_TEMPO', 'LEAF_GUARD',
    # trapping
    ...
    'IMMUNITY', 'LIMBER', 'WATER_VEIL', 'MAGMA_ARMOR', 'INSOMNIA', 'VITAL_SPIRIT',
    'SWEET_VEIL', 'PASTEL_VEIL',
]
...
NOOP_ABILITIES = {
    ...
    'HYDRATION', 'EARLY_BIRD', 'WONDER_SKIN', 'SAND_VEIL',
...
UNMODELLED_ABILITIES = {
    ...
    'ANGER_POINT',   # needs a crit mechanic; engine has none
    'MAGIC_BOUNCE',  # needs move-redirection back to the user; engine has none
}
